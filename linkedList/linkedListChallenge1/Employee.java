 ...
 * 
 * Data Structure: Employee (linkedListChallenge1)
 * 
...
public class Employee 
{
	...
	/**
	 * ---- toSTRING_METHOD() ---- toString: I want a toString() 
	 * method generated. I want to be able to @Override the 
	 * default because when I print an employee instance I'd like 
	 * to see a firstName, lastName, and employeeID, I don't just 
