...
public class EmployeeMain 
{
	...
	{
		/*
		 * Initialize an instance of the class ArrayStack().
		 * It enables me with full access to all data fields 
		 * of the said class
		 */
		ArrayStack stack = new ArrayStack( 10 );
		
		stack.push( new Employee( "Jack", "MeOff", 5545454 ) );
		stack.push( new Employee( "Nicko", "Balakhof", 8675309 ) );
		stack.push( new Employee( "Deez", "Nuttz", 3698369 ) );
		stack.push( new Employee( "John", "Doe", 6666969 ) );
		stack.push( new Employee( "Bill", "End", 7896896 ) );
		
		System.out.println( "Push Employee List onto the Display Screen!" );
		stack.printStack();
		...
		System.out.println();
		System.out.println( "\t\t---- POP_ITEMS_FROM_THE_STACK ----");
		
		System.out.println( "POPPED: " + stack.pop() );
		
		System.out.println();
		
		System.out.println( "\t\t---- POST_POPPING_ITEM_FROM_THE_STACK ----");
