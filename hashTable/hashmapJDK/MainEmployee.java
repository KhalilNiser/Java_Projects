...
/**
 * @author Niser, Khalil (06/17/2023)
 * 
...
package hashTable.hashmapJDK;

import java.util.HashMap;
import java.util.Iterator;
import java.util.Map;

import hashTable.chaining.Employee;
...
public class MainEmployee 
{
	...
	public static void main(String[] args) 
	{
		...
		// Here the name in Value replaces name in Key
//		System.out.println( "Here the name in Value, replaces name in Key");
//		hashMap.put( "Doe", mikeWilson );.
		
		// Here the name in Value replaces name in Key
		// Because of the method "putIfAbsent"
//		System.out.println( "Here the name in Value, replaces name in Key"
//				+ "\nBecause of the method \"putIfAbsent\"" );
//		hashMap.putIfAbsent( "Doe", mikeWilson );
		...
		System.out.println( hashMap.getOrDefault( "smeone", mikeWilson ) );
		
		System.out.println( "\t\t---- REMOVE_EMPLOYEE ----");
...
//		System.out.println( "Here the name in  Key, replaces the name in Value");
//		Employee employee = hashMap.put( "Doe", mikeWilson );
//		System.out.println( employee );
		
		/*
		 * There is a "hashMap.containsKey" and a "hashMap.containsValue" 
		 * method to see if a map contains a key or a value.
		 * NOTE: "hashMap.containsKey", is faster and "hashMap.containsValue".
		 * Because in the "containsKey" method we're passing the key, where as 
		 * in the "containsValue" method we're passing an object.
		 */
//		System.out.println( hashMap.containsKey( "Doe" ) );
//		System.out.println( hashMap.containsValue( janeJones ));
		
		/*
		 * 				---- PRINT_OUT_HASHTABLE_USING_ITERATOR ----
		 * 
		 */
		System.out.println( "Print out HashTable Using Iterator!");
		...
		/*
		 * 				---- PRINT_OUT_HASHTABLE_USING_FOREACH_METHOD ----
		 * For this one I will use the "key (k = key)" and the "value= v". 
		 * NOTE: In this program I used "Employee" as my "value" variable.
		 */
		
		System.out.println();
		System.out.println( "_____________________________________________"
				+ "___________________________________________________");
		System.out.println( "Print out HashTable Using For_EACH Statement!");
