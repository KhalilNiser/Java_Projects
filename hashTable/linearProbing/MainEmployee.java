...
public class MainEmployee 
{
	...
	public static void main(String[] args) 
	{
		 ...
		 *  
		 */
		SimpleHashtableArray hT = new SimpleHashtableArray();
		...
		System.out.println( "Retreive the Key Wilson: " + hT.retreive( "Wilson" ) );
		System.out.println( "Retreive the Key Smith: " + hT.retreive( "Smith" ) );
	}
